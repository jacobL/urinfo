...
def WebCrawling():
    ...
    try:
        ...
        baseUrl = 'https://www.ednasia.com/news/'
            ...
            if res.status_code == 200:
                ...
                for new in news:
                    ...
                    if contentres.status_code == 200:
                        ...
                        contents = contentsoup.select('div.pf-content > p')
                        ...
                        if publishdate < (datetime.today() - timedelta(days=1)).strftime('%Y%m%d'):
                            print('4.EDNNews ',creationdate,' total:',c)
                            return

                    #print("============================================================")
                    #print(publishdate, title, url, content, creationdate)
                    #print('EDNNews ',publishdate, title)
                    #print("============================================================")
    ...
    # =============================================================================
        ...
        print('Exception EDNNewsCrawling:'+str(e))
    print('4.EDNNews ',creationdate,' total:',c)
