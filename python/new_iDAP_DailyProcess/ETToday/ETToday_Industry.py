#############################################
# 網站名稱：ET TODAY
# 網址： https://finance.ettoday.net/focus/776
# 爬取類型： 產業綜合
# 爬取範圍： 今日、昨日
#############################################
...
def WebCrawling(days = 2):
    ...
    passwd = "1234"
    db = 'idap'
    web = "ETToday_Industry" 
    tag = "Industry"
    
    targetUrl = "https://finance.ettoday.net/focus/776/{}"
    page = 1
    lastPageDesc = ''
    ...
    try:
        ...
        print('Exception ETToday_Industry:'+str(e))
    print('ETToday_Industry ',creationdate,' total:',c)
