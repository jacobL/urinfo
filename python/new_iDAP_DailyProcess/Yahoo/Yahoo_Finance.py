#############################################
# 網站名稱：Yahoo!奇摩
# 網址： https://tw.news.yahoo.com/finance
# 爬取類型： 財經
# 爬取範圍： 今日、昨日
#############################################
...
def WebCrawling():
    ...
    targetUrl = 'https://tw.news.yahoo.com/_td-news/api/resource/IndexDataService.getExternalMediaNewsList;count=10;loadMore=true;mrs=%7B%22size%22%3A%7B%22w%22%3A220%2C%22h%22%3A128%7D%7D;newsTab=finance;start={};tag=%5B%22yct%3A001000298%22%2C%22yct%3A001000123%22%5D;usePrefetch=false?bkt=news-TW-zh-Hant-TW-def&device=desktop&ecma=modern&feature=oathPlayer%2CvideoDocking&intl=tw&lang=zh-Hant-TW&partner=none&prid=5g9sfatftjelv&region=TW&site=news&tz=Asia%2FTaipei&ver=2.3.1550&returnMeta=true'
