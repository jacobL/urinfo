#############################################
# 網站名稱：Yahoo!奇摩
# 網址： https://tw.news.yahoo.com/world
# 爬取類型： 國際
# 爬取範圍： 今日、昨日
#############################################
...
def WebCrawling():
    ...
    targetUrl = 'https://tw.news.yahoo.com/_td-news/api/resource/IndexDataService.getExternalMediaNewsList;count=10;loadMore=true;mrs=%7B%22size%22%3A%7B%22w%22%3A220%2C%22h%22%3A128%7D%7D;newsTab=world;start={};tag=%5B%22ymedia%3Acategory%3D000000030%22%2C%22ymedia%3Acategory%3D000000032%22%5D;usePrefetch=false?bkt=news-TW-zh-Hant-TW-def&device=desktop&ecma=modern&feature=oathPlayer%2CvideoDocking&intl=tw&lang=zh-Hant-TW&partner=none&prid=eneqc15ftjhl6&region=TW&site=news&tz=Asia%2FTaipei&ver=2.3.1550&returnMeta=true'
